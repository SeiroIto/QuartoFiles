...
format:
  revealjs: 
    ...
    footer: <http://seiroito.github.io/Miscellaneous/QuartoFiles/posts/BarrEgglestonSmith/BarrEgglestonSmith2022.html>
    theme: sky
include-in-header:
  - text: |
      <style>
...
* Much smaller impacts for nonfirstborn given transfer is $306 vs. $1,291 (Tab A.VI)  
...
* Larger impacts in later years (Fig V)  
...
2. Stress&darr; (no direct evidence shown in this paper)  
   ...
   * Reduced stress changes in interactions with children [@MilliganStabile2011; @EvansGarthwaite2014]  
...
::: {.incremental}
* $\sigma$&uarr; = $2500&uarr; at age 28 per year [@ChettyFriedmanRockoff2014b]  
