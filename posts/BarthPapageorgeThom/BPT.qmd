...
2. Of using retired households: More precise wealth but smaller sample size/more selection [(Table 3)](BarthPapgergeThome_SNPWealth_JPE2020.pdf#page=17) 
...
* Previous studies: EA scores $\SIM$ education
* This study: EA scores $\SIM$ wealth
