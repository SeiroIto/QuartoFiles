...
*********************************************************************/
clear all
infile using "$HRSSurveys00/h00sta/H00J_H.dct" , using("$HRSSurveys00/h00da/H00J_H.da")
local year "2000"
sort HHID GSUBHH
gen SUBHH=GSUBHH
destring HHID, gen(numHHID)
destring SUBHH, gen(numSUBHH)
gen h5hhid=numHHID*10+numSUBHH

/************************************
	IRA 1 STOCK ALLOCATIONS
************************************/
gen IRA1PercStocks=0
replace IRA1PercStocks=100 if G5352==1
replace IRA1PercStocks=0   if G5352==2
replace IRA1PercStocks=50  if G5352==3
replace IRA1PercStocks=.   if G5352==7 | G5352==8 | G5352==9

/************************************
	IRA 2 STOCK ALLOCATIONS
************************************/
gen IRA2PercStocks=0
replace IRA2PercStocks=100 if G5373==1
replace IRA2PercStocks=0   if G5373==2
replace IRA2PercStocks=50  if G5373==3
replace IRA2PercStocks=.   if G5373==7 | G5373==8 | G5373==9

/************************************
	IRA 3 STOCK ALLOCATIONS
************************************/
gen IRA3PercStocks=0
replace IRA3PercStocks=100 if G5392==1
replace IRA3PercStocks=0   if G5392==2
replace IRA3PercStocks=50  if G5392==3
replace IRA3PercStocks=.   if G5392==7 | G5392==8 | G5392==9

/********************************************************************************************************
                                 Inheritance Code	
********************************************************************************************************/
gen RecInher_1_`year'      =.
replace RecInher_1_`year'  =0 if G5861==5 | (G5862<=7 & G5862>=1)
replace RecInher_1_`year'  =1 if G5862==3

gen YearInher_1_`year'     =G5864
replace YearInher_1_`year' =. if G5864==9998 | G5864==9999

gen MonthInher_1_`year'    =G5863
replace MonthInher_1_`year'=. if G5863==98 | G5863==99

gen InherAmt_1_`year'      =G5865
replace InherAmt_1_`year'  =. if G5865==9999998 | G5865==9999999
/*                  14.  R'S PARENTS
                    15.  BROTHER
                    17.  SISTER
                    19.  OTHER RELATIVE
...
gen InherRecWho_1_`year'     =G5867

gen RecInher_2_`year'      =.
replace RecInher_2_`year'  =0 if G5868==5 | (G5869<=7 & G5869>=1)
replace RecInher_2_`year'  =1 if G5869==3

gen YearInher_2_`year'     =G5871
replace YearInher_2_`year' =. if G5871==9998 | G5871==9999

gen MonthInher_2_`year'    =G5870
replace MonthInher_2_`year'=. if G5870==98 | G5870==99

gen InherAmt_2_`year'      =G5872
replace InherAmt_2_`year'  =. if G5872==9999998 | G5872==9999999
gen InherRecWho_2_`year'     =G5874

gen RecInher_3_`year'      =.
replace RecInher_3_`year'  =0 if G5875==5 | (G5876<=7 & G5876>=1)
replace RecInher_3_`year'  =1 if G5876==3

gen YearInher_3_`year'     =G5878
replace YearInher_3_`year' =. if G5878==9998 | G5878==9999

gen MonthInher_3_`year'    =G5877
replace MonthInher_3_`year'=. if G5877==98 | G5877==99

gen InherAmt_3_`year'      =G5879
replace InherAmt_3_`year'  =. if G5879==9999998 | G5879==9999999
gen InherRecWho_3_`year'     =G5881


/*********************************************************************************************
	MERGE WITH RAND DATA
*********************************************************************************************/
keep h5hhid HHID SUBHH IRA1PercStocks IRA2PercStocks IRA3PercStocks *Inher*
isid h5hhid
save "$CleanData/IRAStocks`year'.dta", replace
merge 1:m h5hhid using "$CleanData/temp1`year'.dta"
