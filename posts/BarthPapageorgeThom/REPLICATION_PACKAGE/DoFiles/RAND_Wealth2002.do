...
*********************************************************************/
clear all
infile using "$HRSSurveys02/h02sta/H02Q_H.dct" , using("$HRSSurveys02/h02da/H02Q_H.da")
local year "2002"
sort HHID HSUBHH
gen SUBHH=HSUBHH
destring HHID, gen(numHHID)
destring SUBHH, gen(numSUBHH)
gen h6hhid=numHHID*10+numSUBHH

/************************************
	IRA 1 STOCK ALLOCATIONS
************************************/
gen IRA1PercStocks=0
replace IRA1PercStocks=100 if HQ180_1==1
replace IRA1PercStocks=0   if HQ180_1==2
replace IRA1PercStocks=50  if HQ180_1==3
replace IRA1PercStocks=.   if HQ180_1==7 | HQ180_1==8 | HQ180_1==9

/************************************
	IRA 2 STOCK ALLOCATIONS
************************************/
gen IRA2PercStocks=0
replace IRA2PercStocks=100 if HQ180_2==1
replace IRA2PercStocks=0   if HQ180_2==2
replace IRA2PercStocks=50  if HQ180_2==3
replace IRA2PercStocks=.   if HQ180_2==7 | HQ180_2==8 | HQ180_2==9

/************************************
	IRA 3 STOCK ALLOCATIONS
************************************/
gen IRA3PercStocks=0
replace IRA3PercStocks=100 if HQ180_3==1
replace IRA3PercStocks=0   if HQ180_3==2
replace IRA3PercStocks=50  if HQ180_3==3
replace IRA3PercStocks=.   if HQ180_3==7 | HQ180_3==8 | HQ180_3==9

/********************************************************************************************************
                                 Inheritance Code	
********************************************************************************************************/
gen RecInher_1_`year'      =.
replace RecInher_1_`year'  =0 if HQ483_1==5 | (HQ484_1<=7 & HQ484_1>=1)
replace RecInher_1_`year'  =1 if HQ484_1==3

gen YearInher_1_`year'     =HQ487_1
replace YearInher_1_`year' =. if HQ487_1==9998 | HQ487_1==9999

gen MonthInher_1_`year'    =HQ486_1
replace MonthInher_1_`year'=. if HQ486_1==98 | HQ486_1==99

gen InherAmt_1_`year'      =HQ488_1
replace InherAmt_1_`year'  =. if HQ488_1==9999998 | HQ488_1==9999999
/*                  14.  R'S PARENTS
                    15.  BROTHER
                    17.  SISTER
                    19.  OTHER RELATIVE
...
gen InherRecWho_1_`year'     =HQ490_1

gen RecInher_2_`year'      =.
replace RecInher_2_`year'  =0 if HQ483_2==5 | (HQ484_2<=7 & HQ484_2>=1)
replace RecInher_2_`year'  =1 if HQ484_2==3

gen YearInher_2_`year'     =HQ487_2
replace YearInher_2_`year' =. if HQ487_2==9998 | HQ487_2==9999

gen MonthInher_2_`year'    =HQ486_2
replace MonthInher_2_`year'=. if HQ486_2==98 | HQ486_2==99

gen InherAmt_2_`year'      =HQ488_2
replace InherAmt_2_`year'  =. if HQ488_2==9999998 | HQ488_2==9999999

gen InherRecWho_2_`year'     =HQ490_2

gen RecInher_3_`year'      =.
replace RecInher_3_`year'  =0 if HQ483_3==5 | (HQ484_3<=7 & HQ484_3>=1)
replace RecInher_3_`year'  =1 if HQ484_3==3

gen YearInher_3_`year'     =HQ487_3
replace YearInher_3_`year' =. if HQ487_3==9998 | HQ487_3==9999

gen MonthInher_3_`year'    =HQ486_3
replace MonthInher_3_`year'=. if HQ486_3==98 | HQ486_3==99

gen InherAmt_3_`year'      =HQ488_3
replace InherAmt_3_`year'  =. if HQ488_3==9999998 | HQ488_3==9999999

gen InherRecWho_3_`year'     =HQ490_3


/*********************************************************************************************
	MERGE WITH RAND DATA
*********************************************************************************************/
keep h6hhid HHID SUBHH IRA1PercStocks IRA2PercStocks IRA3PercStocks *Inher*
isid h6hhid

save "$CleanData/IRAStocks`year'.dta", replace
merge 1:m h6hhid using "$CleanData/temp1`year'.dta"
