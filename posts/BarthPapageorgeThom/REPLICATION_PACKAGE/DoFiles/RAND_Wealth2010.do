...
*********************************************************************/
clear all
infile using "$HRSSurveys10/h10sta/H10Q_H.dct" , using("$HRSSurveys10/h10da/H10Q_H.da")
local year "2010"
sort HHID MSUBHH
gen SUBHH=MSUBHH
destring HHID, gen(numHHID)
destring SUBHH, gen(numSUBHH)
gen h10hhid=numHHID*10+numSUBHH

/************************************
	IRA 1 STOCK ALLOCATIONS
************************************/
gen IRA1HasStocks =.
replace IRA1HasStocks=1 if MQ513_1==1
replace IRA1HasStocks=0 if MQ513_1==5
replace IRA1HasStocks=0 if MQ513_1==.

gen IRA1PercStocks=MQ514_1
replace IRA1PercStocks=0 if IRA1HasStocks==0
replace IRA1PercStocks=. if MQ514_1==998 | MQ514_1==999

replace IRA1PercStocks=50 if MQ515_1==3
sum IRA1PercStocks if IRA1PercStocks!=. & IRA1PercStocks<50, det
replace IRA1PercStocks=r(p50) if MQ515_1==1
sum IRA1PercStocks if IRA1PercStocks!=. & IRA1PercStocks>50, det
replace IRA1PercStocks=r(p50) if MQ515_1==5

/************************************
	IRA 2 STOCK ALLOCATIONS
************************************/
gen IRA2HasStocks =.
replace IRA2HasStocks=1 if MQ513_2==1
replace IRA2HasStocks=0 if MQ513_2==5
replace IRA2HasStocks=0 if MQ513_2==.

gen IRA2PercStocks=MQ514_2
replace IRA2PercStocks=0 if IRA2HasStocks==0
replace IRA2PercStocks=. if MQ514_2==998 | MQ514_2==999

replace IRA2PercStocks=50 if MQ515_2==3
sum IRA2PercStocks if IRA2PercStocks!=. & IRA2PercStocks<50, det
replace IRA2PercStocks=r(p50) if MQ515_2==1
sum IRA2PercStocks if IRA2PercStocks!=. & IRA2PercStocks>50, det
replace IRA2PercStocks=r(p50) if MQ515_2==5

/************************************
	IRA 3 STOCK ALLOCATIONS
************************************/
gen IRA3HasStocks =.
replace IRA3HasStocks=1 if MQ513_3==1
replace IRA3HasStocks=0 if MQ513_3==5
replace IRA3HasStocks=0 if MQ513_3==.

gen IRA3PercStocks=MQ514_3
replace IRA3PercStocks=0 if IRA3HasStocks==0
replace IRA3PercStocks=. if MQ514_3==998 | MQ514_3==999

replace IRA3PercStocks=50 if MQ515_3==3
sum IRA3PercStocks if IRA3PercStocks!=. & IRA3PercStocks<50, det
replace IRA3PercStocks=r(p50) if MQ515_3==1
sum IRA3PercStocks if IRA3PercStocks!=. & IRA3PercStocks>50, det
replace IRA3PercStocks=r(p50) if MQ515_3==5

/********************************************************************************************************
                                 Inheritance Code	
********************************************************************************************************/
gen RecInher_1_`year'      =.
replace RecInher_1_`year'  =0 if MQ483_1==5 | (MQ484_1<=7 & MQ484_1>=1)
replace RecInher_1_`year'  =1 if MQ484_1==3

gen YearInher_1_`year'     =MQ487_1
replace YearInher_1_`year' =. if MQ487_1==9998 | MQ487_1==9999

gen MonthInher_1_`year'    =MQ486_1
replace MonthInher_1_`year'=. if MQ486_1==98 | MQ486_1==99

gen InherAmt_1_`year'      =MQ488_1
replace InherAmt_1_`year'  =. if MQ488_1==9999998 | MQ488_1==9999999
/*                  14.  R'S PARENTS
                    15.  BROTHER
                    17.  SISTER
                    19.  OTHER RELATIVE
...
gen InherRecWho_1_`year'     =MQ490_1

gen RecInher_2_`year'      =.
replace RecInher_2_`year'  =0 if MQ483_2==5 | (MQ484_2<=7 & MQ484_2>=1)
replace RecInher_2_`year'  =1 if MQ484_2==3

gen YearInher_2_`year'     =MQ487_2
replace YearInher_2_`year' =. if MQ487_2==9998 | MQ487_2==9999

gen MonthInher_2_`year'    =MQ486_2
replace MonthInher_2_`year'=. if MQ486_2==98 | MQ486_2==99

gen InherAmt_2_`year'      =MQ488_2
replace InherAmt_2_`year'  =. if MQ488_2==9999998 | MQ488_2==9999999

gen InherRecWho_2_`year'     =MQ490_2

gen RecInher_3_`year'      =.
replace RecInher_3_`year'  =0 if MQ483_3==5 | (MQ484_3<=7 & MQ484_3>=1)
replace RecInher_3_`year'  =1 if MQ484_3==3

gen YearInher_3_`year'     =MQ487_3
replace YearInher_3_`year' =. if MQ487_3==9998 | MQ487_3==9999

gen MonthInher_3_`year'    =MQ486_3
replace MonthInher_3_`year'=. if MQ486_3==98 | MQ486_3==99

gen InherAmt_3_`year'      =MQ488_3
replace InherAmt_3_`year'  =. if MQ488_3==9999998 | MQ488_3==9999999

gen InherRecWho_3_`year'     =MQ490_3

/*********************************************************************************************
	MERGE WITH RAND DATA
*********************************************************************************************/
keep h10hhid HHID SUBHH IRA1HasStocks IRA2HasStocks IRA3HasStocks IRA1PercStocks IRA2PercStocks IRA3PercStocks *Inher*
isid h10hhid
save "$CleanData/IRAStocks`year'.dta", replace
merge 1:m h10hhid using "$CleanData/temp1`year'.dta"
