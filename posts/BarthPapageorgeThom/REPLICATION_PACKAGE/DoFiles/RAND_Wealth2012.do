...
*********************************************************************/
clear all
infile using "$HRSSurveys12/h12sta/H12Q_H.dct" , using("$HRSSurveys12/h12da/H12Q_H.da")
local year "2012"
sort HHID NSUBHH
gen SUBHH=NSUBHH
destring HHID, gen(numHHID)
destring SUBHH, gen(numSUBHH)
gen h11hhid=numHHID*10+numSUBHH

/************************************
	IRA 1 STOCK ALLOCATIONS
************************************/
gen IRA1HasStocks =.
replace IRA1HasStocks=1 if NQ513_1==1
replace IRA1HasStocks=0 if NQ513_1==5
replace IRA1HasStocks=0 if NQ513_1==.

gen IRA1PercStocks=NQ514_1
replace IRA1PercStocks=0 if IRA1HasStocks==0
replace IRA1PercStocks=. if NQ514_1==998 | NQ514_1==999

replace IRA1PercStocks=50 if NQ515_1==3
sum IRA1PercStocks if IRA1PercStocks!=. & IRA1PercStocks<50, det
replace IRA1PercStocks=r(p50) if NQ515_1==1
sum IRA1PercStocks if IRA1PercStocks!=. & IRA1PercStocks>50, det
replace IRA1PercStocks=r(p50) if NQ515_1==5

/************************************
	IRA 2 STOCK ALLOCATIONS
************************************/
gen IRA2HasStocks =.
replace IRA2HasStocks=1 if NQ513_2==1
replace IRA2HasStocks=0 if NQ513_2==5
replace IRA2HasStocks=0 if NQ513_2==.

gen IRA2PercStocks=NQ514_2
replace IRA2PercStocks=0 if IRA2HasStocks==0
replace IRA2PercStocks=. if NQ514_2==998 | NQ514_2==999

replace IRA2PercStocks=50 if NQ515_2==3
sum IRA2PercStocks if IRA2PercStocks!=. & IRA2PercStocks<50, det
replace IRA2PercStocks=r(p50) if NQ515_2==1
sum IRA2PercStocks if IRA2PercStocks!=. & IRA2PercStocks>50, det
replace IRA2PercStocks=r(p50) if NQ515_2==5

/************************************
	IRA 3 STOCK ALLOCATIONS
************************************/
gen IRA3HasStocks =.
replace IRA3HasStocks=1 if NQ513_3==1
replace IRA3HasStocks=0 if NQ513_3==5
replace IRA3HasStocks=0 if NQ513_3==.

gen IRA3PercStocks=NQ514_3
replace IRA3PercStocks=0 if IRA3HasStocks==0
replace IRA3PercStocks=. if NQ514_3==998 | NQ514_3==999

replace IRA3PercStocks=50 if NQ515_3==3
sum IRA3PercStocks if IRA3PercStocks!=. & IRA3PercStocks<50, det
replace IRA3PercStocks=r(p50) if NQ515_3==1
sum IRA3PercStocks if IRA3PercStocks!=. & IRA3PercStocks>50, det
replace IRA3PercStocks=r(p50) if NQ515_3==5

/********************************************************************************************************
                                 Inheritance Code	
********************************************************************************************************/
gen RecInher_1_`year'      =.
replace RecInher_1_`year'  =0 if NQ483_1==5 | (NQ484_1<=7 & NQ484_1>=1)
replace RecInher_1_`year'  =1 if NQ484_1==3

gen YearInher_1_`year'     =NQ487_1
replace YearInher_1_`year' =. if NQ487_1==9998 | NQ487_1==9999

gen MonthInher_1_`year'    =NQ486_1
replace MonthInher_1_`year'=. if NQ486_1==98 | NQ486_1==99

gen InherAmt_1_`year'      =NQ488_1
replace InherAmt_1_`year'  =. if NQ488_1==9999998 | NQ488_1==9999999
/*                  14.  R'S PARENTS
                    15.  BROTHER
                    17.  SISTER
                    19.  OTHER RELATIVE
...
gen InherRecWho_1_`year'     =NQ490_1

gen RecInher_2_`year'      =.
replace RecInher_2_`year'  =0 if NQ483_2==5 | (NQ484_2<=7 & NQ484_2>=1)
replace RecInher_2_`year'  =1 if NQ484_2==3

gen YearInher_2_`year'     =NQ487_2
replace YearInher_2_`year' =. if NQ487_2==9998 | NQ487_2==9999

gen MonthInher_2_`year'    =NQ486_2
replace MonthInher_2_`year'=. if NQ486_2==98 | NQ486_2==99

gen InherAmt_2_`year'      =NQ488_2
replace InherAmt_2_`year'  =. if NQ488_2==9999998 | NQ488_2==9999999

gen InherRecWho_2_`year'     =NQ490_2

gen RecInher_3_`year'      =.
replace RecInher_3_`year'  =0 if NQ483_3==5 | (NQ484_3<=7 & NQ484_3>=1)
replace RecInher_3_`year'  =1 if NQ484_3==3

gen YearInher_3_`year'     =NQ487_3
replace YearInher_3_`year' =. if NQ487_3==9998 | NQ487_3==9999

gen MonthInher_3_`year'    =NQ486_3
replace MonthInher_3_`year'=. if NQ486_3==98 | NQ486_3==99

gen InherAmt_3_`year'      =NQ488_3
replace InherAmt_3_`year'  =. if NQ488_3==9999998 | NQ488_3==9999999

gen InherRecWho_3_`year'     =NQ490_3


/*********************************************************************************************
	MERGE WITH RAND DATA
*********************************************************************************************/
keep h11hhid HHID SUBHH IRA1HasStocks IRA2HasStocks IRA3HasStocks IRA1PercStocks IRA2PercStocks IRA3PercStocks *Inher*
isid h11hhid
save "$CleanData/IRAStocks`year'.dta", replace
merge 1:m h11hhid using "$CleanData/temp1`year'.dta"
