...
format:
  revealjs: 
    ...
    footer: <http://seiroito.github.io/QuartoFiles/Horton/Horton2025.html>
    theme: sky
include-in-header:
  - text: |
      <style>
...
## Firms' minimum wage adjustments

MW&uarr;...,,,

* Employment head counts&darr;
...
* Applicants: Not aware of MW, but bid < MW not accepted
* Employers: Not aware of MW, see applicant profiles
* Headcounts&darr; little
* Hours&darr by 27% for low wage jobs
